  ...
  >
    ...
    <div class="mt-10 flex flex-col items-center justify-center gap-y-8">
      <div style="opacity: 1">
        ...
        >
          ...
          <span
            class="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-violet-400/0 via-violet-400/90 to-violet-400/0 transition-opacity duration-500 group-hover:gopacity-40"
          ></span>
        </button>
      </div>
    ...
    <div class="perspective-[1500px] relative pt-16" style="opacity: 1">
      <NuxtParticles
        id="tsparticles"
        :options="options"
        class="pointer-events-none absolute -top-36 left-1/2 h-[32rem] w-full -translate-x-1/2 -translate-y-1/2 overflow-hidden w-[60rem]"
        @load="onLoad"
      />
    </div>
  </div>
